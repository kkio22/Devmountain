...
public final class AiConstants {
	...
	public static final String RECOMMENDATION_PROMPT = """
		...
		- 각 강의는 lectureId,title, description, instructor, level, thumbnailUrl 을 포함해야 해.
		...
		- 응답 예시: {"recommendations": [{"lectureId":"숫자"  "title": "스프링 입문", "description": "...", "instructor": "...", "level": "초급", "thumbnailUrl": "some_url.jpg" }]}
		""";
